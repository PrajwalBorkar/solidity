...
// TypeError 5407: (621-627): Cannot implicitly convert component at position 0 from "tuple(int_const 1,int_const 2)" to "int256": Array literal can not be converted to byte array or string.
